...
namespace JobIT.web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IUserDetailsRepository userDetailsRepo)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            // Use the value of user_name instead of model.Email because UserName and Email carry different values in the Register Action
